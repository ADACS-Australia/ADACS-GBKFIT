"""
Django settings for gbkfit project.
...
SECRET_KEY = '3)kfyad$mkl^1+66l5b6&1s0-k_aup!1jmw2)elq(jb!kcg_tg'
...
WSGI_APPLICATION = 'gbkfit.wsgi.application'
...
AUTH_USER_MODEL = 'gbkfit_web.User'
